 ...
 */
static void base_w(uint32_t *output, const int out_len, /* change: consistency */
...
static void wots_checksum(uint32_t *csum_base_w, /* change: consistency */
                          const uint32_t *msg_base_w) /* change: consistency */
{
    unsigned int csum = 0;
...
void wots_pk_from_sig(unsigned char *pk,
                      ...
                      const spx_ctx *ctx, uint32_t addr[8])
{
    uint32_t lengths[SPX_WOTS_LEN]; /* changed: consistency */
    uint32_t i;
